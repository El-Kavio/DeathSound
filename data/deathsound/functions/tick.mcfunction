...
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 18 run execute at @a run playsound minecraft:item.trident.thunder master @a ~ ~ ~ 1 2
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 19 run execute at @a run playsound minecraft:item.trident.riptide_3 master @a ~ ~ ~ 1 0
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 20 run execute at @a run playsound minecraft:event.raid.horn master @a ~ ~ ~ 100 0
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 21 run execute at @a run playsound minecraft:entity.zombie.attack_wooden_door master @a ~ ~ ~ 1 0
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 22 run execute at @a run playsound minecraft:entity.skeleton_horse.death master @a ~ ~ ~ 1 2
execute as @a if score @s[scores={RollCount=0..}] RollCount matches 23 run execute at @a run playsound minecraft:block.conduit.attack.target master @a ~ ~ ~ 1 0
